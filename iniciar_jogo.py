...
def creditos():
	...
	while not sair:
		...
		surface_texto, rect_texto = text_objects("Programadora: Vitória Maria R. Alencar", fonte, BRANCO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 3)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("Disciplina: Programação 2 ", fonte, BRANCO)
...
def regras():
	...
	while not sair:
		...
		info1 = fonte.render('O jogo de damas é praticado em um tabuleiro de 64 casas.', False, (AZUL))
		info2 = fonte.render('O objetivo do jogo é capturar todas as peças do oponente.', False, (VERDE_ESCURO))
		info3 = fonte.render('A peça anda só para frente, uma casa de cada vez, na diagonal.', False, (VERDE_ESCURO))
		info4 = fonte.render('Quando a peça atinge a oitava linha do tabuleiro ela vira dama.', False, (VERDE_ESCURO))
		info5 = fonte.render('A dama é uma peça de movimentos mais amplos. Ela anda para frente e para trás,', False, (AZUL))
		info6 = fonte.render('quantas casas quiser, não podendo saltar sobre uma peça da mesma cor. ', False, (AZUL))
		info7 = fonte.render('A captura é obrigatória, ou seja, não existe sopro.', False, (VERDE_ESCURO))
		info8 = fonte.render('Duas ou mais peças juntas, na mesma diagonal, não podem ser capturadas.', False, (VERDE_ESCURO))
		info9 = fonte.render('A peça e a dama podem capturar tanto para frente como para trás.', False, (AZUL))
		info10 = fonte.render('O movimento de captura pode ser encadeado sem que o jogador passe a vez.', False, (AZUL))
		
		game1 = fonte.render('Durante o jogo, ao clicar em uma peça, sera exibido em verde os movimentos', False, (VERMELHO))
		game2 = fonte.render('possiveis da mesma. Se nada acontecer ao clicar em uma peça, significa que', False, (VERMELHO))
		game3 = fonte.render('ela não tem movimentos possiveis ou o turno pertence ao outro jogador.', False, (VERMELHO))
